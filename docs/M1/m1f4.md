...
!!! note "Preparación del Lote y refactorizar el codigo (1ª parte)"
   ...
   4. Ahora deberíamos recorrer el array `lista_archivos` y para cada imagen, ejecutar las fases de inferencia vistas en la sección anterior. 
    ...
    for nombre_archivo in lista_archivos:
        ...
        # Aquí obtendriamos la predicción del modelo llamando a una función que implemente las fases de inferencia
        ...
        if etiqueta_predicha == etiqueta_esperada:
            ...
            info_error= {"archivo": nombre_archivo, "prediccion": etiqueta_predicha, "probabilidad": probabilidad}
            predicciones_incorrectas.append(nombre_archivo)
