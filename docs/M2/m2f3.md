...
!!! task "A204 (CE2) - Diseño esquema físico de red"

    Cada grupo tiene asignado un plano técnico de la oficina de su empresa digitalizadora. En este plano, deben diseñar el esquema físico de la red, indicando la ubicación de los dispositivos de red, los hosts y los medios de transmisión. 

    **El trabajo debe ser individual**. Sobre el plano digitalizado, deberás:

    - Ubicar el Hardware: Colocar iconos representativos de los dispositivos de red (Router, Switch, Puntos de Acceso Wi-Fi).

    - Trazado de Red: Dibujar el cableado estructurado siguiendo las paredes y canalizaciones del plano, diferenciando visualmente las conexiones por cable (Ethernet) de las inalámbricas.
    ...
    - **Cableado red**. Tipo, categoría, metros bobina, precio.
...
!!! task "A205.1(CE1) - Diseño esquema lógico de red"

    En esta **actividad individual**, deberás diseñar el esquema lógico de red asociado al esquema físico que has diseñado en la actividad anterior. Para ello, deberás tomar como referencia la imágen de ejemplo del esquema lógico de red que se muestra en la introducción de este sprint, y realizar un diseño similar para tu empresa digitalizadora.
    ...
    2. En el diagrama de red, **se deben incluir los siguientes elementos**:
        - Nube de Internet.
        - Router de salida con su dirección IP asignada.
        - Switch de red.
        - Equipos terminales como puntos de acceso inalámbricos,equipos de escritorio, portátiles, impresoras, etc...
        - Se debe indicar por cada dispositivo su dirección IP asignada, su máscara de red, su puerta de enlace. Los equipos de sobremesa e impresoras deberán tener además un nombre de equipo asignado.
        - Se deben diferenciar visualmente los dispositivos cableados de los dispositivos inalámbricos, por ejemplo, utilizando colores diferentes para cada tipo de dispositivo.
        - Se debe agrupar los dispositivos por estancias, por ejemplo, utilizando recuadros con líneas discontinuas para delimitar cada estancia, y colocando el nombre de la estancia en el interior del recuadro.
