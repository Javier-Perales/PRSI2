...
!!! question "A203(CE2, CE5) Placas Base"
    ...
    | Características / Placas               | **MSI MAG Z790 Tomahawk** | **ASUS ROG Strix Z790-E** | **Gigabyte X870E AORUS** | **ASUS Pro WS TRX50-SAGE** | **ASUS Pro WS TRX50-SAGE** |
    |----------------------------------------|---------|---------|---------|---------|---------|
    | **Soket**                                  |         |         |         |         |         |
    ...
    - [Pc Part Picker - Comparador de compatibilidad](https://pcpartpicker.com/products/motherboard/)
